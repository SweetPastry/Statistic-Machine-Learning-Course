...
$$
F\left( s \right) =-st+\frac{s^2\sum\li'm'k_{i=1}^N{\left( b_i-a_i \right) ^2}}{8N^2}.
$$

求导

$$
F^{\prime}\left( s \right) =-t+\frac{s\sum_{i=1}^N{\left( b_i-a_i \right) ^2}}{4N^2}.
$$

得到

$$
s_0=\frac{4N^2t}{\sum_{i=1}^N{\left( b_i-a_i \right) ^2}}.
$$
