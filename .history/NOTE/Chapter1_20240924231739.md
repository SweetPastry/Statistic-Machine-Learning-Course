...
$$
P\left[ \forall f\in \mathcal{F} :\quad R\left( f \right) -\hat{R}\left( f \right) \leqslant \varepsilon \left( d,N,\delta \right) \right] \geqslant 1-\sqrt{\frac{1}{2N}\left( \log d+\log \frac{1}{\delta} \right)}.
$$
