...
$$
P\left( \bar{X}-\mu \geqslant t \right) \leqslant \exp \left( -st \right) \prod_{i=1}^N{\exp \frac{s^2\left( b_i-a_i \right) ^2}{8N^2}}=\exp \left( -st \right) \exp \frac{s^2\sum_{i=1}^N{\left( b_i-a_i \right) ^2}}{8N^2}
$$