...
$$
\exp \left( -\frac{2d^2}{\sum\limits_{i=1}^n{\left( b_i-a_i \right) ^2}}\frac{1}{2N}\left( \log d+\log \frac{1}{\delta} \right) \right) \leqslant \delta.
$$

利用误差的取值范围

$$
\exp \left( -\frac{d}{2N}\left( \log d+\log \frac{1}{\delta} \right) \right) \leqslant \delta .
$$
