...
$$
P\left[ \exists f\in \mathcal{F} : R\left( f \right) -\hat{R}\left( f \right) \geqslant \varepsilon \left( d,N,\delta \right) \right] \leqslant \sqrt{\frac{1}{2N}\left( \log d+\log \frac{1}{\delta} \right)}.
$$
