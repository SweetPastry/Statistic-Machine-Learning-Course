...
$$
\exp \left( -\frac{d^2}{\sum\limits_{i=1}^n{\left( b_i-a_i \right) ^2}}\frac{1}{2N}\left( \log d+\log \frac{1}{\delta} \right) \right) \leqslant \sqrt{\frac{1}{2N}\left( \log d+\log \frac{1}{\delta} \right)}.
$$

利用误差的取值范围

$$
\exp \left( -\frac{d}{2N}\left( \log d+\log \frac{1}{\delta} \right) \right) \leqslant \sqrt{\frac{1}{2N}\left( \log d+\log \frac{1}{\delta} \right)}
$$
